...
main(int argc, char *argv[])
{
  ...
  28:	c7 44 24 0c 4e 07 00 	movl   $0x74e,0xc(%esp)
  2f:	00 
  30:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  34:	83 c3 01             	add    $0x1,%ebx
  37:	c7 44 24 04 50 07 00 	movl   $0x750,0x4(%esp)
  3e:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 38c:	f7 f1                	div    %ecx
 38e:	0f b6 92 5e 07 00 00 	movzbl 0x75e(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 518:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        ...
        if(s == 0)
          s = "(null)";
 51b:	b8 57 07 00 00       	mov    $0x757,%eax
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
...
malloc(uint nbytes)
{
 ...
 679:	8b 55 08             	mov    0x8(%ebp),%edx
  if((prevp = freep) == 0){
 67c:	8b 0d f4 09 00 00    	mov    0x9f4,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
malloc(uint nbytes)
{
 ...
 6af:	76 4f                	jbe    700 <malloc+0x90>
    ...
    if(p == freep)
 6b1:	3b 05 f4 09 00 00    	cmp    0x9f4,%eax
...
morecore(uint nu)
{
 ...
 6e7:	e8 f4 fe ff ff       	call   5e0 <free>
  return freep;
 6ec:	8b 0d f4 09 00 00    	mov    0x9f4,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 70c:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 70f:	89 0d f4 09 00 00    	mov    %ecx,0x9f4
      return (void*)(p + 1);
 ...
 72d:	09 00 00 
    base.s.size = 0;
 730:	b8 f8 09 00 00       	mov    $0x9f8,%eax
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 735:	c7 05 f8 09 00 00 f8 	movl   $0x9f8,0x9f8
 73c:	09 00 00 
    base.s.size = 0;
